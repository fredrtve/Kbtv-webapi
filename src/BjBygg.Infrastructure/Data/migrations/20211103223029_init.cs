        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MissionActivities_Activities_ActivityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MissionActivityId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Timesheets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Timesheets_MissionActivities_MissionActivityId",
                        column: x => x.MissionActivityId,
                        principalTable: "MissionActivities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MissionActivities_ActivityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timesheets_MissionActivityId",
                table: "Timesheets",
                column: "MissionActivityId");
        }
