...
{
    public class UpdateMissionTypeHandler : IRequestHandler<UpdateMissionTypeCommand>
    {
        ...
        public async Task<Unit> Handle(UpdateMissionTypeCommand request, CancellationToken cancellationToken)
        {
