...
{
    public class ReportTypeSyncHandler : IRequestHandler<ReportTypeSyncQuery, DbSyncResponse<ReportTypeDto>>
    {
        private readonly AppDbContext _dbContext;
        private readonly IMapper _mapper;

        public ReportTypeSyncHandler(AppDbContext dbContext, IMapper mapper)
        {
            _dbContext = dbContext;
            _mapper = mapper;
        }

        public async Task<DbSyncResponse<ReportTypeDto>> Handle(ReportTypeSyncQuery request, CancellationToken cancellationToken)
        {
            List<ReportType> entities;
            ...
            return new DbSyncResponse<ReportTypeDto>()
            {
